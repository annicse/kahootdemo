...
/* harmony import */ var _components_mainmenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/mainmenu */ "./assets/js/components/mainmenu.js");

_components_mainmenu__WEBPACK_IMPORTED_MODULE_0__["default"].init();
...
var menuItems = mainMenu.querySelectorAll('li > a');
var Mainmenu = {
  ...
  init: function init() {
    ...
    document.querySelector('body').addEventListener('click', function (e) {
      ...
      if (path.some(function (elem) {
        return elem.id === 'menu-toggle';
      })) return;

      if (!path.some(function (elem) {
        return elem.id === 'menu-container';
      })) {
        Mainmenu.closeMenu();
      }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkkahoot_test"] = self["webpackChunkkahoot_test"] || [];
